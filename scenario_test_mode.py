...
# -*- coding: utf-8 -*-
"""
Scenario-based test mode window for testing by scenarios from test_scenarios.json.
"""
...
class ScenarioTestModeWindow(tk.Toplevel):
    ...
    def create_scenario_selection_screen(self):
        ...
        title_label = tk.Label(
            header_frame,
            text="Выбор сценария тестирования",
            font=("Arial", 16, "bold"),
            bg="#2196F3",
            fg="white"
        )
        ...
        # Listbox with scrollbar for scenarios
        list_frame = tk.Frame(form_frame, bg="white")
        ...
        select_btn = tk.Button(
            form_frame,
            text="Выбрать сценарий и начать тест",
            font=("Arial", 12, "bold"),
            bg="#4CAF50",
            fg="white",
            relief=tk.FLAT,
    ...
    def select_scenario(self):
        ...
        # Show scenario details and confirm
    ...
    def show_scenario_details(self):
        ...
        back_btn = tk.Button(
            ...
            relief=tk.FLAT,
            cursor="hand2",
            command=self.create_scenario_selection_screen
        )
        back_btn.pack(side=tk.LEFT, padx=15, pady=15)

        title_label = tk.Label(
            header_frame,
            text="Детали сценария",
            font=("Arial", 16, "bold"),
            bg="#2196F3",
            fg="white"
        )
        ...
        # Scenario info
        info_frame = tk.Frame(main_frame, bg="white", relief=tk.RIDGE, bd=2)
        info_frame.pack(fill=tk.X, pady=(0, 20))
        info_frame.configure(padx=30, pady=30)
        ...
        tk.Label(
            info_frame,
            text=f"Количество вопросов: {len(self.selected_scenario.get('questions', []))}",
            font=("Arial", 11, "bold"),
            bg="white",
            fg="#2196F3"
        ...
        start_btn = tk.Button(
            info_frame,
            text="Начать тестирование по сценарию",
            font=("Arial", 12, "bold"),
            bg="#4CAF50",
            fg="white",
            relief=tk.FLAT,
            ...
            pady=10,
            cursor="hand2",
            command=self.start_scenario_test
        )
        start_btn.pack()

    def start_scenario_test(self):
        """Start the test with questions from the selected scenario."""
        # Load questions from scenario (they're already in internal format)
        ...
        # Convert questions if needed (they should already be in internal format)
    ...
    def show_question(self):
        ...
        title_label = tk.Label(
            header_frame,
            text=f"Тестирование: {self.selected_scenario['title']}",
            font=("Arial", 14, "bold"),
            bg="#2196F3",
            fg="white"
        )
    ...
    def show_single_choice(self, parent, question_data):
        """Display single choice question with no default selection."""
        options = question_data.get("options", [])
    ...
    def show_true_false(self, parent, question_data):
        """Display true/false question with no default selection."""
    ...
    def finish_test(self):
        ...
        result = {
            ...
            "test_type": "scenario",
            "scenario_id": self.selected_scenario.get("id"),
            "scenario_title": self.selected_scenario.get("title")
        }
    ...
    def show_results(self, result):
        ...
        title_label = tk.Label(
            header_frame,
            text="Результаты тестирования по сценарию",
            font=("Arial", 16, "bold"),
            bg="#4CAF50",
            fg="white"
        )
